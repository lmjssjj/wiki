...
public class MobileSignalController extends SignalController<
    ...
    /// @ }
	//wangyan
	private boolean isza50apn = "1".equals(android.os.SystemProperties.get("ro.za50_spn", "0"));
	
	//swallow add
    private boolean isSignalType2G3G4G = SystemProperties.get("ro.hx_signal_2g3g4g").equals("1");
    private boolean isVolteChangeState = SystemProperties.get("ro.hx_change_volte_state").equals("1"); 
    private boolean isZhuoXinTeZondaUi = SystemProperties.get("ro.hx_zxt_zonda_ui").equals("1");
	private boolean isQ812KS680mHisense = SystemProperties.get(
			"ro.q812_caifu9_ks680m_hisense").equals("1");
    //swallow end
    ...
    public void updateConnectivity(BitSet connectedTransports, BitSet validatedTransports) {
        ...
        mCurrentState.inetCondition = 1;//swallow modify 20170503, removed the signal shown"!"
    ...
    private void mapIconSets() {
        ...
        //swallow modify 20170513
        if (SystemProperties.get("ro.hx_zxt_telcel_ui").equals("1")) {
            mNetworkToIconLookup.put(TelephonyManager.NETWORK_TYPE_GPRS, TelephonyIcons.E);
            ...
            if (!mConfig.showAtLeast3G) {
				...
				//swallow modify 20170526
                mNetworkToIconLookup.put(TelephonyManager.NETWORK_TYPE_EDGE, TelephonyIcons.E);
                mNetworkToIconLookup.put(TelephonyManager.NETWORK_TYPE_CDMA, TelephonyIcons.E);
                mNetworkToIconLookup.put(TelephonyManager.NETWORK_TYPE_1xRTT, TelephonyIcons.E);
				//swallow end
                mDefaultIcons = TelephonyIcons.E;
            } else {
                mNetworkToIconLookup.put(TelephonyManager.NETWORK_TYPE_UNKNOWN,
            ...
            mNetworkToIconLookup.put(TelephonyManager.NETWORK_TYPE_HSPAP, TelephonyIcons.H_PLUS);//swallow modify 20170602

            mNetworkToIconLookup.put(TelephonyManager.NETWORK_TYPE_LTE, TelephonyIcons.FOUR_G);

            mNetworkToIconLookup.put(TelephonyManager.NETWORK_TYPE_IWLAN, TelephonyIcons.WFC);
            /// M: Support 4G+ icon
            mNetworkToIconLookup.put(TelephonyManager.NETWORK_TYPE_LTEA, TelephonyIcons.LTE);
        } 
        //swallow modify 20170712
        else if (isZhuoXinTeZondaUi) {
            mNetworkToIconLookup.put(TelephonyManager.NETWORK_TYPE_GPRS, TelephonyIcons.G);
            mNetworkToIconLookup.put(TelephonyManager.NETWORK_TYPE_EVDO_0, TelephonyIcons.THREE_G);
            mNetworkToIconLookup.put(TelephonyManager.NETWORK_TYPE_EVDO_A, TelephonyIcons.THREE_G);
            mNetworkToIconLookup.put(TelephonyManager.NETWORK_TYPE_EVDO_B, TelephonyIcons.THREE_G);
            mNetworkToIconLookup.put(TelephonyManager.NETWORK_TYPE_EHRPD, TelephonyIcons.THREE_G);
    		...
    		//NUUCHANGE add for xinjide data icon start
    		if("1".equals(SystemProperties.get("ro.hx_xinjide_am_custom_ui"))){
				int am_mcc = 0;
				String mcc = null;
				try{
					mcc = TelephonyManager.from(mContext).getNetworkOperator().substring(0,3);
				}catch(Exception ex){
					Log.e("NUUCHANGE","mcc is null");
				}
				am_mcc = mSubscriptionInfo.getMcc();
				Log.d("NUUCHANGE", "am_mcc===" + am_mcc);
			//	if(am_mcc>0 && ((am_mcc == 460) || (am_mcc == 311) ||(am_mcc == 312)
							//	|| (am_mcc == 313)||(am_mcc == 314) || (am_mcc == 315)|| (am_mcc == 316))){
				if(mcc != null && (mcc.equals("310")|| (mcc.equals("311")) ||(mcc.equals("312"))
								|| mcc.equals("313")|| mcc.equals("314") || mcc.equals("315")||mcc.equals("316"))){
					mNetworkToIconLookup.put(TelephonyManager.NETWORK_TYPE_HSDPA, TelephonyIcons.FOUR_G);
					mNetworkToIconLookup.put(TelephonyManager.NETWORK_TYPE_HSUPA, TelephonyIcons.FOUR_G);
					mNetworkToIconLookup.put(TelephonyManager.NETWORK_TYPE_HSPA, TelephonyIcons.FOUR_G);
				...
				//NUUCHANGE add H+ icon start
					if (mConfig.hspaDataDistinguishable) {
						mNetworkToIconLookup.put(TelephonyManager.NETWORK_TYPE_HSPAP, TelephonyIcons.H_PLUS);
					}else if("1".equals(SystemProperties.get("ro.hx_kata_ca_signal_icon"))){
						 mNetworkToIconLookup.put(TelephonyManager.NETWORK_TYPE_HSPAP, TelephonyIcons.FOUR_G);
					}else{
						mNetworkToIconLookup.put(TelephonyManager.NETWORK_TYPE_HSPAP, hGroup);
					}
				}
				//NUUCHANGE add H+ icon end
    			//mNetworkToIconLookup.put(TelephonyManager.NETWORK_TYPE_HSDPA, TelephonyIcons.FOUR_G);
    			//mNetworkToIconLookup.put(TelephonyManager.NETWORK_TYPE_HSUPA, TelephonyIcons.FOUR_G);
    			//mNetworkToIconLookup.put(TelephonyManager.NETWORK_TYPE_HSPA, TelephonyIcons.FOUR_G);
    			//mNetworkToIconLookup.put(TelephonyManager.NETWORK_TYPE_HSPAP, TelephonyIcons.FOUR_G);
			...
			if("1".equals(SystemProperties.get("ro.hx_xinjide_am_custom_ui"))){
				int am_mcc1 = 0;
				am_mcc1 = mSubscriptionInfo.getMcc();
				
				String mcc1 = null;
				try{
					mcc1 = TelephonyManager.from(mContext).getNetworkOperator().substring(0,3);
				}catch(Exception ex){
					Log.e("NUUCHANGE","mcc1 is null");
				}
					am_mcc1 = mSubscriptionInfo.getMcc();
					
					Log.d("NUUCHANGE", "mcc1===" + mcc1);
					//Log.d("NUUCHANGE", "am_mcc1===" + am_mcc1);
				//	if(am_mcc>0 && ((am_mcc == 460) || (am_mcc == 311) ||(am_mcc == 312)
								//	|| (am_mcc == 313)||(am_mcc == 314) || (am_mcc == 315)|| (am_mcc == 316))){
				if(mcc1 != null && (mcc1.equals("310") || mcc1.equals("311") ||mcc1.equals("312")
									|| mcc1.equals("313")|| mcc1.equals("314") || mcc1.equals("315")|| mcc1.equals("316"))){
				Log.d("NUUCHANGE", "4G is LTE");
		...
		//NUUCHANGE add for xinjide data icon end
            ...
            if (isSignalType2G3G4G){
                ...
                if (!mConfig.showAtLeast3G) {
                    mNetworkToIconLookup.put(TelephonyManager.NETWORK_TYPE_UNKNOWN,TelephonyIcons.UNKNOWN);
                    mNetworkToIconLookup.put(TelephonyManager.NETWORK_TYPE_EDGE, TelephonyIcons.TWO_2G);
                    mNetworkToIconLookup.put(TelephonyManager.NETWORK_TYPE_CDMA, TelephonyIcons.TWO_2G);
                    mNetworkToIconLookup.put(TelephonyManager.NETWORK_TYPE_1xRTT, TelephonyIcons.TWO_2G);
                    mDefaultIcons = TelephonyIcons.TWO_2G;
                } else {
                    mNetworkToIconLookup.put(TelephonyManager.NETWORK_TYPE_UNKNOWN,
                            TelephonyIcons.THREE_G);
                    mNetworkToIconLookup.put(TelephonyManager.NETWORK_TYPE_EDGE,
                ...
                /// M: Support 4G+ icon
                mNetworkToIconLookup.put(TelephonyManager.NETWORK_TYPE_LTEA, TelephonyIcons.FOUR_G);
            }//swallow end
        }
    }
    ...
    public void notifyListeners(SignalCallback callback) {
        ...
        boolean showDataIcon = mCurrentState.dataConnected
                ...
                || dataDisabled;
		//add by wangyan
		if(SystemProperties.get("ro.data_disabled_icon").equals("0")){
		...
		//modify by wangyan
		if(SystemProperties.get("ro.data_disabled_icon").equals("1")){
		...
		//swallow modify 20170728
		boolean mDateEnable = true;
		if (isQ812KS680mHisense){
			mDateEnable = mPhone.getDataEnabled(mSubscriptionInfo.getSubscriptionId());
		}
		Log.d(mTag,"mDateEnable = " + mDateEnable);
		//swallow end
        ...
        typeIcon = mStatusBarExt.getDataTypeIcon(
                        ...
                        typeIcon,
                        mDataNetType,
                        (mCurrentState.dataConnected && mDateEnable) ?//swallow modify 20170728
        ...
        /** @ }*/
		//add by lmn
		callback.setDataActivityMTK(mCurrentState.dataConnected && mCurrentState.activityIn,mCurrentState.dataConnected && mCurrentState.activityOut,mSubscriptionInfo.getSubscriptionId());
    ...
    private void handleImsAction(Intent intent){
        ...
        if (mCurrentState.isOverwfc){
            ...
            //swallow modify 20170608
            if (isVolteChangeState 
                ...
                if (isChecked == 1) {
                    if (getVolteState() == PhoneConstants.IMS_STATE_ENABLING) {
                        mCurrentState.volteIcon = NetworkTypeUtils.VOLTE_ICON_WARNING;
                    } else if (getVolteState() == PhoneConstants.IMS_STATE_ENABLE) {
                        mCurrentState.volteIcon = NetworkTypeUtils.VOLTE_ICON_ACTIVATE;
                    } else {
                        mCurrentState.volteIcon = NetworkTypeUtils.VOLTE_ICON_ERROR;
                    }
                } else {
                    mCurrentState.volteIcon = NetworkTypeUtils.VOLTE_ICON_ERROR;
                }
    ...
    //swallow modify 20170608
    private int getVolteState() {
        int imsState = PhoneConstants.IMS_STATE_DISABLED;
        try {
            imsState = ImsManager.getInstance(mContext, SubscriptionManager
                .getDefaultVoiceSubscriptionId()).getImsState();
            Log.d("swallow","imsState = " + imsState);
    ...
    void updateNetworkName(boolean showSpn, String spn, String dataSpn,
		...
		if(isza50apn){
			try {
				Log.d("CarrierLabel", "wangyan plmn = " + plmn);
				if(plmn.equals("A")){
					plmn = "A1";
				} 
				if(plmn.equals("FL")){
				...
				Log.e("CarrierLabel", "wangyan numeric " + e);
			}
		}
		//end
     ...
     */
    private int oldLevel = 0;////swallow modify 20161209
    private final void updateTelephony() {
        ...
        if (isCarrierNetworkChangeActive()) {
            ...
            mCurrentState.iconGroup = TelephonyIcons.ROAMING;
			//modify by wangyan
        } else if (isDataDisabled() && SystemProperties.get("ro.data_disabled_icon").equals("1")) {
        //end
    ...
    **/
    ...
    class MobilePhoneStateListener extends PhoneStateListener {
        ...
        public void onDataConnectionStateChanged(int state, int networkType) {
            ...
            mDataNetType =
                NetworkTypeUtils.getDataNetTypeFromServiceState(mDataNetType, mServiceState);
			//NUUCHANGE add for xjd am data icon start
			if("1".equals(SystemProperties.get("ro.hx_xinjide_am_custom_ui"))){
				mapIconSets();
			}//NUUCHANGE add for xjd am data icon end
            updateTelephony();
        }
