...
//Readmine 2247 yucongcong add for *#*#888#*#* 2019-10-09 begin
import android.os.SystemProperties;
//Readmine 2247 yucongcong add for *#*#888#*#* 2019-10-09 end
...
public class DialpadFragment extends Fragment
  ...
  public void afterTextChanged(Editable input) {
    ...
    /*redmine2391 add for audio auto test 2019-10-17 begin*/
    String enableADB = "*#35#*";
    if(digits.getText().toString().equals(enableADB)){
      Settings.Global.putInt(getActivity().getContentResolver(),"adbenable", 1);
      Settings.Global.putInt(getActivity().getContentResolver(),Settings.Global.ADB_ENABLED, 1);
      digits.getText().clear();
      return ;
    }
    /*redmine2391 add for audio auto test 2019-10-17 end*/

    //add for factorymode begin
      String factorymode = "*#*#96#*#*";
      if(digits.getText().toString().equals(factorymode)){
              try{
                 Intent factoryTestIntent = new Intent();
                 factoryTestIntent.setComponent(new android.content.ComponentName("com.nuu.factorymode","com.nuu.factorymode.TestMainActivity"));
    ...
    //add for factorymode end
    
    
    //add for agingtest apk begin
	String agingtest = "*#*#666#*#*";
	String agingtest2 = "*#333#*";
	if(digits.getText().toString().equals(agingtest) || digits.getText().toString().equals(agingtest2)){
		try{
			Intent agingTestIntent = new Intent();
			agingTestIntent.setComponent(new android.content.ComponentName("com.example.lxn.agingtestnew","com.example.lxn.agingtestnew.MainActivity"));
			agingTestIntent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK|Intent.FLAG_ACTIVITY_CLEAR_TASK);
	...
	//add for agingtest apk end


    //redmine 2324 add *#*#0*# factory reset  2019-10-18 begin
        String factoryReset = "*#0*#";
       if(digits.getText().toString().equals(factoryReset)){
       ...
       //redmine 2324  add *#*#0*# factory reset  2019-10-18 end
     //Readmine 2247  add for *#*#888#*#* 2019-10-09 begin
      /* redmine 4009  modify  *#*#888#*#* to show device info 2019-11-01 begin
      String phoneInformation = "*#*#888#*#*";
       if(digits.getText().toString().equals(phoneInformation)){
       ...
       redmine 4009  modify  *#*#888#*#* to show device info 2019-11-01 end*/
       //Readmine 2247  add for *#*#888#*#* 2019-10-09 end
